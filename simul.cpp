...
std::vector<Body> initBodies = {
    {0.0f, -0.07f, 0.0f, 0.0f, 600000.0f, 1.0f, 0.0f, 0.0f},   // 빨강
    {-0.80f - 0.06f, -0.07f, 0.0f, 0.223f + 0.0518f, 100.0f, 0.0f, 1.0f, 0.0f},    // 초록
    {-0.80f, -0.07f, 0.0f, 0.223f, 4000.0f, 0.0f, 0.0f, 1.0f}     // 파랑
};
